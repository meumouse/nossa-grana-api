...
const DEFAULT_CATEGORIES: Array<{
  ...
  { name: 'Educação', kind: 'EXPENSE', nature: 'FIXED', color: '#eab308' },
  // Despesas variáveis
  { name: 'Mercado', kind: 'EXPENSE', nature: 'VARIABLE', color: '#3b82f6' },
  { name: 'Transporte', kind: 'EXPENSE', nature: 'VARIABLE', color: '#6366f1' },
  { name: 'Saúde', kind: 'EXPENSE', nature: 'VARIABLE', color: '#06b6d4' },
  // Lazer
  { name: 'Lazer', kind: 'EXPENSE', nature: 'LEISURE', color: '#ec4899' },
  { name: 'Restaurantes', kind: 'EXPENSE', nature: 'LEISURE', color: '#d946ef' },
  // Investimento
  { name: 'Investimentos', kind: 'EXPENSE', nature: 'INVESTMENT', color: '#10b981' },
  // Outros
  { name: 'Outros', kind: 'EXPENSE', nature: 'OTHER', color: '#64748b' },
];
